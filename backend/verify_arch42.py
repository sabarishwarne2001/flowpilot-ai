...
def check_wiring(texts: dict[str, str]) -> None:
    ...
    assert 'REVIEW_KIND_MERGE: str = "MERGE"' in texts["review_model"] and (
        ...
        or "    REVIEW_KIND_MERGE,\n    REVIEW_KIND_SPLIT,\n    REVIEW_KIND_TABLE,\n    REVIEW_KIND_CORROBORATION,\n    REVIEW_KIND_OBLIGATION,\n    REVIEW_KIND_POSTING,\n)" in texts["review_model"])  # ARCH44-S1:review-kinds-widened-42  ARCH45-S1:review-kinds-widened-42  ARCH46-S1:review-kinds-widened-42  ARCH47-S1:review-kinds-widened-42
    ...
    newest47 = VERSIONS / "arch47_step1_erp_posting.py"  # ARCH47-S1:vocab-widened-42
    ref = _load_module("_m47", newest47) if newest47.exists() else ref
