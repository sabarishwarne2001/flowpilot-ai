...
def gates_db(rec: Recorder) -> None:
    ...
    try:
        def head() -> None:
            ...
            assert value in (EXPECTED_HEAD, "arch39_step1_conversations", "arch37_step1_flow_builder", "arch38_step1_batches"), (  # ARCH37-S1:head-widened-36  ARCH38-S1:head-widened-36
