...
export const buildWorkspaceNavigationGroups = (
  ...
  },
  {
    ...
    items: [
      ...
      // ARCH46-S2:nav-obligations
      {
        id: "obligations",
        name: "Obligations",
        route: "workspaceObligations",
        path: obligationsPath(orgSlug, workspaceSlug),
        icon: CalendarClock,
        description: "Renewals, notice deadlines, payments and reports read from documents, on a calendar",
        capability: CAPABILITY.obligations,
        keywords: ["obligations", "deadlines", "renewal", "notice", "due date", "calendar", "ical", "expiry", "reminder"],
      },
    ],
  },
  {
