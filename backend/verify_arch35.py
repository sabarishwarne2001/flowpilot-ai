...
def gates_db(rec: Recorder) -> None:
    ...
    def head_and_tables() -> None:
        ...
        assert head in ("arch35_step1_calibration", "arch39_step1_conversations", "arch37_step1_flow_builder", "arch38_step1_batches", "arch40_step2_settings_backfill", "arch40_step2a_review_view_paths", "arch40_step3_contract_ai_settings", "hm1_tier_price_per_key", "arch41_step1_extraction_memory"), (  # ARCH37-S1:head-widened-35  ARCH38-S1:head-widened-35  ARCH40-S1:head-widened-35  # HM-S1:head-widened  ARCH41-S2:head-widened-35
