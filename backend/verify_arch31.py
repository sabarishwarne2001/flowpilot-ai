...
def gates_db(rec: Recorder, database_url: str) -> None:
    ...
    def single_alembic_head() -> None:
        ...
        assert heads in (["arch31_step1_procurement_matching"], ["arch32_step1_redaction"], ["arch33_step1_assertions"], ["arch34_step1_radar"], ["arch35_step1_calibration"], ["arch39_step1_conversations"], ["arch37_step1_flow_builder"], ["arch38_step1_batches"], ["arch40_step2_settings_backfill"], ["arch40_step2a_review_view_paths"], ["arch40_step3_contract_ai_settings"], ["hm1_tier_price_per_key"], ["arch41_step1_extraction_memory"]), heads  # ARCH37-S1:head-widened-31  ARCH38-S1:head-widened-31  ARCH40-S1:head-widened-31  # HM-S1:head-widened  ARCH41-S2:head-widened-31
